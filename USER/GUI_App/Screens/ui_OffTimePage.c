...
void ui_LOffTimeSetPage_screen_init(void)
{
    ...
    lv_label_set_text(ui_LTimeSetUnitLabel, "\xe7\xa7\x92");
    ...
    lv_label_set_text(ui_LTimeSetOKLabel, "\xee\xb4\x9d");
...
void ui_TOffTimeSetPage_screen_init(void)
{
    ...
    lv_label_set_text(ui_TTimeSetUnitLabel, "\xe7\xa7\x92");
    ...
    lv_label_set_text(ui_TTimeSetOKLabel, "\xee\xb4\x9d");
