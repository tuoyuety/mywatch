...
void ui_DateTimeSetPage_screen_init(void)
{
    ...
    lv_label_set_text(ui_APPSyLabel, "\xe5\x90\x8c\xe6\xad\xa5\x41\x50\x50");
    ...
    lv_label_set_text(ui_DateSetLabel, "\xe6\x97\xa5\xe6\x9c\x9f\xe8\xae\xbe\xe7\xbd\xae");
    ...
    lv_label_set_text(ui_TimeSetLabel, "\xe6\x97\xb6\xe9\x97\xb4\xe8\xae\xbe\xe7\xbd\xae");
...
void ui_DateSetPage_screen_init(void)
{
    ...
    lv_label_set_text(ui_DateSetOKicon, "\xee\xb4\x9d");
...
void ui_TimeSetPage_screen_init(void)
{
    ...
    lv_label_set_text(ui_TimeSetOKicon, "\xee\xb4\x9d");
