...
static const char * num_list[] = {"0", "1", "2", "3", "4", "5", "6", "7", "8"};
...
void ui_GameMemPage_screen_init(void)
{
    ...
    lv_label_set_text(new_game_btn_label, "\xe9\x87\x8d\x20\xe7\x8e\xa9");
...
void Game_Mem_Init(void)
{
    ...
    Game_Mem.previous_id = 0xFFu;
    Game_Mem.present_id = 0xFFu;
